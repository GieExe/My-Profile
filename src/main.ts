...
const projects: Project[] = [
  {
    ...
    description: "This system is an offline, computer-based solution designed to streamline daily operations for veterinary clinics and pet shops. It ensures data security and reliability by allowing access and use even without internet connectivity.",
    technologies: ["VB.NET", "MySQL", "Visual Studio"],
    liveDemoLink: "https://www.canva.com/design/DAFi5c44Z5s/C0t6PUsgFnAMCDUITgfFeg/view?utm_content=DAFi5c44Z5s&utm_campaign=designshare&utm_medium=link2&utm_source=uniquelinks&utlId=h78df776f54",
    imagePlaceholder: "https://imgur.com/f6gpSdS.jpg"
  },
  {
    title: "Flask API for Database Management (Integration with Mobile and Web application)",
    description: "This system is a web-based API solution designed to streamline data management through CRUD operations. It leverages a Tembo (PostgreSQL) database for reliable data storage and integrates with Firebase for enhanced features.",
    technologies: ["Python", "Flask", "Render", "Firebase", "PostgreSQL"],
